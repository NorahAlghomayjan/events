...
<body>
	<div class="container m-5 row">
		<h1 class="col fushia">Welcome <c:out value="${currentUser.firstName }" /> !</h1>
		...
		<!--  -->
		<h5>Here are some events in your  <c:out value="${currentUser.location }" /> </h5>
		...
		<table class="table">
			...
			<c:forEach var="event" items="${userJoinedEventInLocation }">
					<tr>
			...
			<c:forEach var="event" items="${userEventsInLocation }">
					<tr>
						<td><c:out value="${event.name }" /></td>
						<td><c:out value="${event.date }" /></td>
						<td><c:out value="${event.location }" /></td>
			...
			<c:forEach var="event" items="${notJoinedEventsInLocation }">
					<tr>
						<td><c:out value="${event.name }" /></td>
						<td><c:out value="${event.date }" /></td>
						<td><c:out value="${event.location }" /></td>
		...
		<table class="table">
			...
			<c:forEach var="event" items="${userJoinedEvent }">
					<tr>
						<td><c:out value="${event.name }" /></td>
						<td><c:out value="${event.date }" /></td>
						<td><c:out value="${event.location }" /></td>
